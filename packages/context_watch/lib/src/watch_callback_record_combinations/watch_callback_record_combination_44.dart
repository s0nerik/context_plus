...
extension ContextWatchCallbackRecordExt44<TListenable1 extends Listenable, TListenable2 extends Listenable, T3, T4> on (TListenable1, TListenable2, Stream<T3>, Future<T4>) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1, $2, AsyncSnapshot<T3>.nothing(), AsyncSnapshot<T4>.nothing());
