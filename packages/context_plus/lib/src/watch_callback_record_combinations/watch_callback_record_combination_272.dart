...
extension ContextWatchCallbackRecordRefExt272<
  T0,
...
>
  ...
  R watchOnly<R>(
    ...
    R Function(AsyncSnapshot<T0>, TListenable1, TListenable2, TListenable3)
    selector,
  ) {
    return watchOnly4<
      R,
  ...
  void watchEffect(
    BuildContext context,
    void Function(AsyncSnapshot<T0>, TListenable1, TListenable2, TListenable3)
    effect, {
    Object? key,
