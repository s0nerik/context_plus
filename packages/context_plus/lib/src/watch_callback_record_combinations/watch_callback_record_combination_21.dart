...
extension ContextWatchCallbackRecordRefExt21<
...
>
  ...
  R watchOnly<R>(
    ...
    return watchOnly3<R, TListenable0, T2, T4, TListenable0, T2, T4>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect3<TListenable0, T2, T4, TListenable0, T2, T4>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
