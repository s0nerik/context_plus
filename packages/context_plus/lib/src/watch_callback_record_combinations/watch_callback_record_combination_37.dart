...
extension ContextWatchCallbackRecordRefExt37<
...
>
  ...
  R watchOnly<R>(BuildContext context, R Function(T1, T3, T5) selector) {
    return watchOnly3<R, T1, T3, T5, T1, T3, T5>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect3<T1, T3, T5, T1, T3, T5>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
