...
extension ContextWatchCallbackRecordRefExt33<
...
>
  ...
  R watchOnly<R>(
    ...
    return watchOnly3<R, T1, TListenable2, T4, T1, TListenable2, T4>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect3<T1, TListenable2, T4, T1, TListenable2, T4>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
