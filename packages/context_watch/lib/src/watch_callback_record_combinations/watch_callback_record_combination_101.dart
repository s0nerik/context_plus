...
extension ContextWatchCallbackRecordExt101<T1, T2, TListenable3 extends Listenable, T4> on (Stream<T1>, Future<T2>, TListenable3, Future<T4>) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), AsyncSnapshot<T2>.nothing(), $3, AsyncSnapshot<T4>.nothing());
