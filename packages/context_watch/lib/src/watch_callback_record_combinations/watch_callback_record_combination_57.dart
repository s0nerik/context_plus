...
extension ContextWatchCallbackRecordExt57<TListenable1 extends Listenable, T2, TListenable3 extends Listenable, T4> on (TListenable1, Stream<T2>, TListenable3, Stream<T4>) {
