...
extension ContextWatchCallbackRecordRefExt57<TListenable1 extends Listenable, T2, TListenable3 extends Listenable, T4> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Stream<T2>>, context_ref.ReadOnlyRef<TListenable3>, context_ref.ReadOnlyRef<Stream<T4>>) {
