...
extension ContextWatchCallbackRecordRefExt14<TListenable1 extends Listenable, T2, T3> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Future<T2>>, context_ref.ReadOnlyRef<Future<T3>>) {
