...
extension ContextWatchCallbackRecordExt58<TListenable1 extends Listenable, T2, T3, TListenable4 extends Listenable> on (TListenable1, Stream<T2>, Future<T3>, TListenable4) {
