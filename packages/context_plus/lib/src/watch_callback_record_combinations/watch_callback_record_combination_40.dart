...
extension ContextWatchCallbackRecordRefExt40<TListenable1 extends Listenable, TListenable2 extends Listenable, T3, TListenable4 extends Listenable> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<TListenable2>, context_ref.ReadOnlyRef<Future<T3>>, context_ref.ReadOnlyRef<TListenable4>) {
