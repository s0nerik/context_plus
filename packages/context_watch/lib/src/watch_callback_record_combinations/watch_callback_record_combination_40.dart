...
extension ContextWatchCallbackRecordExt40<TListenable1 extends Listenable, TListenable2 extends Listenable, T3, TListenable4 extends Listenable> on (TListenable1, TListenable2, Future<T3>, TListenable4) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1, $2, AsyncSnapshot<T3>.nothing(), $4);
