...
extension ContextWatchCallbackRecordExt13<TListenable1 extends Listenable, T2, TListenable3 extends Listenable> on (TListenable1, Future<T2>, TListenable3) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1, AsyncSnapshot<T2>.nothing(), $3);
