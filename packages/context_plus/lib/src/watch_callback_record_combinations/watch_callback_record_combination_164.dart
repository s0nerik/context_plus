...
extension ContextWatchCallbackRecordRefExt164<
  ...
  T5,
  TListenable6 extends Listenable
>
    on
        (
          ...
          context_ref.ReadOnlyRef<TListenable6>,
        ) {
  ...
  R watchOnly<R>(
    ...
    return watchOnly4<R, T1, T3, T5, TListenable6, T1, T3, T5, TListenable6>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect4<T1, T3, T5, TListenable6, T1, T3, T5, TListenable6>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
