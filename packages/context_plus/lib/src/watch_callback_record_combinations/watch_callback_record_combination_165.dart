...
extension ContextWatchCallbackRecordRefExt165<
...
>
  ...
  R watchOnly<R>(BuildContext context, R Function(T1, T3, T5, T7) selector) {
    return watchOnly4<R, T1, T3, T5, T7, T1, T3, T5, T7>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect4<T1, T3, T5, T7, T1, T3, T5, T7>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
