...
extension ContextWatchCallbackRecordRefExt93<T1, TListenable2 extends Listenable, TListenable3 extends Listenable, T4> on (context_ref.ReadOnlyRef<Stream<T1>>, context_ref.ReadOnlyRef<TListenable2>, context_ref.ReadOnlyRef<TListenable3>, context_ref.ReadOnlyRef<Stream<T4>>) {
