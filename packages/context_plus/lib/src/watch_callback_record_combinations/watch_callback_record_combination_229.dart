...
extension ContextWatchCallbackRecordRefExt229<
  T0,
...
>
  ...
  R watchOnly<R>(
    ...
    return watchOnly4<R, AsyncSnapshot<T0>, T2, T4, T6, T0, T2, T4, T6>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect4<AsyncSnapshot<T0>, T2, T4, T6, T0, T2, T4, T6>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
