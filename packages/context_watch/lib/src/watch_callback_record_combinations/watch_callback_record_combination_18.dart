...
extension ContextWatchCallbackRecordExt18<TListenable1 extends Listenable, T2, T3> on (TListenable1, Stream<T2>, Stream<T3>) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1, AsyncSnapshot<T2>.nothing(), AsyncSnapshot<T3>.nothing());
