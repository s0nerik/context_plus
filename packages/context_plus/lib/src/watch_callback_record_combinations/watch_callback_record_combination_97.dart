...
extension ContextWatchCallbackRecordRefExt97<T1, TListenable2 extends Listenable, T3, TListenable4 extends Listenable> on (context_ref.ReadOnlyRef<Stream<T1>>, context_ref.ReadOnlyRef<TListenable2>, context_ref.ReadOnlyRef<Stream<T3>>, context_ref.ReadOnlyRef<TListenable4>) {
  /// {@macro mass_watch_only_explanation}
  R watchOnly<R>(
    BuildContext context,
    R Function(AsyncSnapshot<T1>, TListenable2, AsyncSnapshot<T3>, TListenable4) selector,
  ) {
    final contextWatch = InheritedContextWatch.of(context);
    
    final observable1 = contextWatch.getOrCreateObservable<T1>(context, $1);
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), $2.of(context), AsyncSnapshot<T3>.nothing(), $4.of(context));
  ...
  void watchEffect(
    BuildContext context,
    void Function(AsyncSnapshot<T1>, TListenable2, AsyncSnapshot<T3>, TListenable4) effect, {
    Object? key,
