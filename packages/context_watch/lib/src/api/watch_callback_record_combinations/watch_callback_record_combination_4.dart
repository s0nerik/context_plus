...
extension ContextWatchCallbackRecordExt4<TListenable0 extends ValueListenable<T1>, T1, TListenable2 extends Listenable> on (TListenable0, TListenable2) {
  ...
  R watchOnly<R>(
    ...
    return watchOnly2<R, T1, TListenable2, T1, TListenable2>(context, selector, $1, $2, ContextWatcherObservableType.valueListenable, ContextWatcherObservableType.listenable);
  }
