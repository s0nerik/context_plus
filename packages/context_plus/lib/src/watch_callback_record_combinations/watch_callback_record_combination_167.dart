...
extension ContextWatchCallbackRecordRefExt167<
...
>
    on
        (
          ...
          context_ref.ReadOnlyRef<Stream<T6>>,
        ) {
  ...
  R watchOnly<R>(
    ...
    return watchOnly4<R, T1, T3, T5, AsyncSnapshot<T6>, T1, T3, T5, T6>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect4<T1, T3, T5, AsyncSnapshot<T6>, T1, T3, T5, T6>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
