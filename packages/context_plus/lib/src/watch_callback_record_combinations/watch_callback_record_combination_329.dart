...
extension ContextWatchCallbackRecordRefExt329<
  T0,
  T1,
  T2,
...
>
  ...
  R watchOnly<R>(
    ...
    R Function(AsyncSnapshot<T0>, AsyncSnapshot<T1>, AsyncSnapshot<T2>, T4)
    selector,
  ) {
    return watchOnly4<
      R,
  ...
  void watchEffect(
    BuildContext context,
    void Function(AsyncSnapshot<T0>, AsyncSnapshot<T1>, AsyncSnapshot<T2>, T4)
    effect, {
    Object? key,
