...
extension ContextWatchCallbackRecordExt109<T1, T2, TListenable3 extends Listenable, TListenable4 extends Listenable> on (Stream<T1>, Stream<T2>, TListenable3, TListenable4) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), AsyncSnapshot<T2>.nothing(), $3, $4);
