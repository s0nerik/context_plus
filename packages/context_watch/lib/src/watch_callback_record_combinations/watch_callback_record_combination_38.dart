...
extension ContextWatchCallbackRecordExt38<TListenable1 extends Listenable, TListenable2 extends Listenable, TListenable3 extends Listenable, T4> on (TListenable1, TListenable2, TListenable3, Future<T4>) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1, $2, $3, AsyncSnapshot<T4>.nothing());
