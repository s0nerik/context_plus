...
extension ContextWatchCallbackRecordExt39<TListenable1 extends Listenable, TListenable2 extends Listenable, TListenable3 extends Listenable, T4> on (TListenable1, TListenable2, TListenable3, Stream<T4>) {
