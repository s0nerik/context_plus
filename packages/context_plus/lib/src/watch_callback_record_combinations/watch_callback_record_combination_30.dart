...
extension ContextWatchCallbackRecordRefExt30<T1, TListenable2 extends Listenable, T3> on (context_ref.ReadOnlyRef<Stream<T1>>, context_ref.ReadOnlyRef<TListenable2>, context_ref.ReadOnlyRef<Stream<T3>>) {
