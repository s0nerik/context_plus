...
extension ContextWatchRecordRefExt59<T0, T1, T2> on (context_ref.ReadOnlyRef<Future<T0>>, context_ref.ReadOnlyRef<Future<T1>>, context_ref.ReadOnlyRef<Stream<T2>>) {
