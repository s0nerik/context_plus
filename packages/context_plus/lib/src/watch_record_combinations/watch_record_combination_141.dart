...
extension ContextWatchRecordRefExt141<T1, T2> on (context_ref.ReadOnlyRef<Listenable>, context_ref.ReadOnlyRef<Stream<T1>>, context_ref.ReadOnlyRef<Stream<T2>>, context_ref.ReadOnlyRef<Listenable>) {
