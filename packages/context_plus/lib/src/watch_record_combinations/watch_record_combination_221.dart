...
extension ContextWatchRecordRefExt221<T0, T2> on (context_ref.ReadOnlyRef<Future<T0>>, context_ref.ReadOnlyRef<Listenable>, context_ref.ReadOnlyRef<Stream<T2>>, context_ref.ReadOnlyRef<Listenable>) {
