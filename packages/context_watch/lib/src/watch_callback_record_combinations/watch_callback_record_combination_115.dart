...
extension ContextWatchCallbackRecordExt115<T1, T2, T3, TListenable4 extends Listenable> on (Stream<T1>, Stream<T2>, Stream<T3>, TListenable4) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), AsyncSnapshot<T2>.nothing(), AsyncSnapshot<T3>.nothing(), $4);
