...
extension ContextWatchCallbackRecordRefExt88<
...
>
  ...
  R watchOnly<R>(
    ...
    R Function(TListenable0, TListenable1, AsyncSnapshot<T2>, TListenable3)
    selector,
  ) {
    return watchOnly4<
      R,
  ...
  void watchEffect(
    BuildContext context,
    void Function(TListenable0, TListenable1, AsyncSnapshot<T2>, TListenable3)
    effect, {
    Object? key,
