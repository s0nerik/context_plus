...
extension ContextWatchCallbackRecordExt68<T1, TListenable2 extends Listenable, T3, T4> on (Future<T1>, TListenable2, Future<T3>, Future<T4>) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), $2, AsyncSnapshot<T3>.nothing(), AsyncSnapshot<T4>.nothing());
