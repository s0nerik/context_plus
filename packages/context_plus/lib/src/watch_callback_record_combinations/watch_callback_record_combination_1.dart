...
extension ContextWatchCallbackRecordRefExt1<TListenable1 extends Listenable, TListenable2 extends Listenable> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<TListenable2>) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1.of(context), $2.of(context));
