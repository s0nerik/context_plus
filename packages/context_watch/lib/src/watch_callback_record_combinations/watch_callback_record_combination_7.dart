...
extension ContextWatchCallbackRecordExt7<T1, TListenable2 extends Listenable> on (Stream<T1>, TListenable2) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), $2);
