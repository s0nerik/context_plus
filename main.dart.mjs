...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1386: x0 => x0.send(),
      _1387: () => new XMLHttpRequest(),
      _1392: Date.now,
      _1394: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1395: s => {
      ...
      _1397: () => typeof dartUseDateNowForTicks !== "undefined",
      _1398: () => 1000 * performance.now(),
      _1399: () => Date.now(),
      _1400: () => {
      ...
      _1402: () => new WeakMap(),
      _1403: (map, o) => map.get(o),
      _1404: (map, o, v) => map.set(o, v),
      _1405: x0 => new WeakRef(x0),
      _1406: x0 => x0.deref(),
      _1413: () => globalThis.WeakRef,
      _1417: s => JSON.stringify(s),
      _1418: s => printToConsole(s),
      _1419: (o, p, r) => o.replaceAll(p, () => r),
      _1420: (o, p, r) => o.replace(p, () => r),
      _1421: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1422: s => s.toUpperCase(),
      _1423: s => s.trim(),
      _1424: s => s.trimLeft(),
      _1425: s => s.trimRight(),
      _1426: (string, times) => string.repeat(times),
      _1427: Function.prototype.call.bind(String.prototype.indexOf),
      _1428: (s, p, i) => s.lastIndexOf(p, i),
      _1429: (string, token) => string.split(token),
      _1430: Object.is,
      _1431: o => o instanceof Array,
      _1432: (a, i) => a.push(i),
      _1436: a => a.pop(),
      _1437: (a, i) => a.splice(i, 1),
      _1438: (a, s) => a.join(s),
      _1439: (a, s, e) => a.slice(s, e),
      _1441: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1442: a => a.length,
      _1444: (a, i) => a[i],
      _1445: (a, i, v) => a[i] = v,
      _1447: o => {
      ...
      _1448: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1450: o => o instanceof Uint8Array,
      _1451: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1452: o => o instanceof Int8Array,
      _1453: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1454: o => o instanceof Uint8ClampedArray,
      _1455: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1456: o => o instanceof Uint16Array,
      _1457: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1458: o => o instanceof Int16Array,
      _1459: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1460: o => o instanceof Uint32Array,
      _1461: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1462: o => o instanceof Int32Array,
      _1463: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1465: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1466: o => o instanceof Float32Array,
      _1467: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1468: o => o instanceof Float64Array,
      _1469: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1470: (t, s) => t.set(s),
      _1472: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1474: o => o.buffer,
      _1475: o => o.byteOffset,
      _1476: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1477: (b, o) => new DataView(b, o),
      _1478: (b, o, l) => new DataView(b, o, l),
      _1479: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1480: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1481: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1482: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1483: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1484: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1485: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1486: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1487: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1488: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1489: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1490: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1493: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1494: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1495: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1496: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1497: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1498: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1511: (ms, c) =>
      ...
      _1533: o => o.length,
      _1535: (o, i) => o[i],
      _1536: f => f.dartFunction,
      _1537: () => ({}),
      _1538: () => [],
      _1540: () => globalThis,
      _1541: (constructor, args) => {
      ...
      _1543: (o, p) => o[p],
      _1544: (o, p, v) => o[p] = v,
      _1545: (o, m, a) => o[m].apply(o, a),
      _1547: o => String(o),
      _1548: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1549: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1549(f,arguments.length,x0) }),
      _1550: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1550(f,arguments.length,x0,x1) }),
      _1551: o => {
      ...
      _1552: o => [o],
      _1553: (o0, o1) => [o0, o1],
      _1554: (o0, o1, o2) => [o0, o1, o2],
      _1555: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1569: x0 => x0.index,
      _1571: x0 => x0.flags,
      _1572: x0 => x0.multiline,
      _1573: x0 => x0.ignoreCase,
      _1574: x0 => x0.unicode,
      _1575: x0 => x0.dotAll,
      _1576: (x0,x1) => { x0.lastIndex = x1 },
      _1577: (o, p) => p in o,
      _1578: (o, p) => o[p],
      _1601: x0 => x0.random(),
      _1604: () => globalThis.Math,
      _1616: Function.prototype.call.bind(Number.prototype.toString),
      _1617: Function.prototype.call.bind(BigInt.prototype.toString),
      _1618: Function.prototype.call.bind(Number.prototype.toString),
      _1619: (d, digits) => d.toFixed(digits),
      _1623: () => globalThis.document,
      _1624: () => globalThis.window,
      _1629: (x0,x1) => { x0.height = x1 },
      _1631: (x0,x1) => { x0.width = x1 },
      _1634: x0 => x0.head,
      _1635: x0 => x0.classList,
      _1639: (x0,x1) => { x0.innerText = x1 },
      _1640: x0 => x0.style,
      _1642: x0 => x0.sheet,
      _1643: x0 => x0.src,
      _1644: (x0,x1) => { x0.src = x1 },
      _1645: x0 => x0.naturalWidth,
      _1646: x0 => x0.naturalHeight,
      _1653: x0 => x0.offsetX,
      _1654: x0 => x0.offsetY,
      _1655: x0 => x0.button,
      _1662: x0 => x0.status,
      _1663: (x0,x1) => { x0.responseType = x1 },
      _1665: x0 => x0.response,
      _3493: () => globalThis.window,
      _3556: x0 => x0.navigator,
      _3945: x0 => x0.userAgent,
