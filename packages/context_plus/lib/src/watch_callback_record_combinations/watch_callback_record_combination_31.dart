...
extension ContextWatchCallbackRecordRefExt31<T1, T2, TListenable3 extends Listenable> on (context_ref.ReadOnlyRef<Stream<T1>>, context_ref.ReadOnlyRef<Future<T2>>, context_ref.ReadOnlyRef<TListenable3>) {
