...
extension ContextWatchCallbackRecordExt19<T1, TListenable2 extends Listenable, TListenable3 extends Listenable> on (Future<T1>, TListenable2, TListenable3) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), $2, $3);
