...
extension ContextWatchCallbackRecordRefExt61<TListenable1 extends Listenable, T2, T3, TListenable4 extends Listenable> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Stream<T2>>, context_ref.ReadOnlyRef<Stream<T3>>, context_ref.ReadOnlyRef<TListenable4>) {
