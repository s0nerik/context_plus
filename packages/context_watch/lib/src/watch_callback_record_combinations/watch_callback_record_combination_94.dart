...
extension ContextWatchCallbackRecordExt94<T1, TListenable2 extends Listenable, T3, TListenable4 extends Listenable> on (Stream<T1>, TListenable2, Future<T3>, TListenable4) {
