...
extension ContextWatchCallbackRecordRefExt59<TListenable1 extends Listenable, T2, T3, T4> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Stream<T2>>, context_ref.ReadOnlyRef<Future<T3>>, context_ref.ReadOnlyRef<Future<T4>>) {
