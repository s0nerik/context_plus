...
extension ContextWatchCallbackRecordExt54<TListenable1 extends Listenable, T2, T3, T4> on (TListenable1, Future<T2>, Stream<T3>, Stream<T4>) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1, AsyncSnapshot<T2>.nothing(), AsyncSnapshot<T3>.nothing(), AsyncSnapshot<T4>.nothing());
