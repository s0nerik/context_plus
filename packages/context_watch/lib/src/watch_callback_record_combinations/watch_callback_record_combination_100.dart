...
extension ContextWatchCallbackRecordExt100<T1, T2, TListenable3 extends Listenable, TListenable4 extends Listenable> on (Stream<T1>, Future<T2>, TListenable3, TListenable4) {
