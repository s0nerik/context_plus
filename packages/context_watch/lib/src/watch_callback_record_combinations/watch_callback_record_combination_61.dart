...
extension ContextWatchCallbackRecordExt61<TListenable1 extends Listenable, T2, T3, TListenable4 extends Listenable> on (TListenable1, Stream<T2>, Stream<T3>, TListenable4) {
