...
extension ContextWatchCallbackRecordRefExt1<TListenable0 extends Listenable, TListenable1 extends ValueListenable<T2>, T2> on (context_ref.ReadOnlyRef<TListenable0>, context_ref.ReadOnlyRef<TListenable1>) {
  ...
  R watchOnly<R>(
    ...
    return watchOnly2<R, TListenable0, T2, TListenable0, T2>(context, selector, $1.of(context), $2.of(context), $1.of(context), $2.of(context).value);
  }
  ...
  void watchEffect(
    ...
    return watchEffect2<TListenable0, T2, TListenable0, T2>(context, effect, $1.of(context), $2.of(context), key: key, immediate: immediate, once: once);
  }
