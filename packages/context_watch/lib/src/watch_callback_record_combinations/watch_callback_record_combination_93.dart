...
extension ContextWatchCallbackRecordExt93<T1, TListenable2 extends Listenable, TListenable3 extends Listenable, T4> on (Stream<T1>, TListenable2, TListenable3, Stream<T4>) {
