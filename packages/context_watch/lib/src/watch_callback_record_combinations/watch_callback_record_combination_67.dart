...
extension ContextWatchCallbackRecordExt67<T1, TListenable2 extends Listenable, T3, TListenable4 extends Listenable> on (Future<T1>, TListenable2, Future<T3>, TListenable4) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), $2, AsyncSnapshot<T3>.nothing(), $4);
