...
extension ContextWatchCallbackRecordRefExt47<TListenable1 extends Listenable, T2, TListenable3 extends Listenable, T4> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Future<T2>>, context_ref.ReadOnlyRef<TListenable3>, context_ref.ReadOnlyRef<Future<T4>>) {
