...
extension ContextWatchCallbackRecordRefExt161<
...
>
  ...
  R watchOnly<R>(
    ...
    return watchOnly4<R, T1, T3, TListenable4, T6, T1, T3, TListenable4, T6>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect4<T1, T3, TListenable4, T6, T1, T3, TListenable4, T6>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
