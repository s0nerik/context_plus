...
extension ContextWatchCallbackRecordRefExt2<TListenable1 extends Listenable, T2> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Future<T2>>) {
