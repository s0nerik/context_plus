...
extension ContextWatchCallbackRecordExt43<TListenable1 extends Listenable, TListenable2 extends Listenable, T3, TListenable4 extends Listenable> on (TListenable1, TListenable2, Stream<T3>, TListenable4) {
