...
extension ContextWatchCallbackRecordExt70<T1, TListenable2 extends Listenable, T3, TListenable4 extends Listenable> on (Future<T1>, TListenable2, Stream<T3>, TListenable4) {
