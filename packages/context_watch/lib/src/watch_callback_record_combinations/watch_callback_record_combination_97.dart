...
extension ContextWatchCallbackRecordExt97<T1, TListenable2 extends Listenable, T3, TListenable4 extends Listenable> on (Stream<T1>, TListenable2, Stream<T3>, TListenable4) {
