...
extension ContextWatchCallbackRecordRefExt128<
...
>
  ...
  R watchOnly<R>(
    ...
    R Function(TListenable0, AsyncSnapshot<T1>, TListenable2, TListenable3)
    selector,
  ) {
    return watchOnly4<
      R,
  ...
  void watchEffect(
    BuildContext context,
    void Function(TListenable0, AsyncSnapshot<T1>, TListenable2, TListenable3)
    effect, {
    Object? key,
