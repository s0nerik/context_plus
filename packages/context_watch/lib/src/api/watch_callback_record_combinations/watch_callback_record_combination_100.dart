...
extension ContextWatchCallbackRecordExt100<TListenable0 extends Listenable, TListenable1 extends ValueListenable<T2>, T2, TListenable3 extends ValueListenable<T4>, T4, TListenable5 extends Listenable> on (TListenable0, TListenable1, TListenable3, TListenable5) {
  ...
  R watchOnly<R>(
    ...
    return watchOnly4<R, TListenable0, T2, T4, TListenable5, TListenable0, T2, T4, TListenable5>(context, selector, $1, $2, $3, $4, $1, $2.value, $3.value, $4);
  }
  ...
  void watchEffect(
    ...
    return watchEffect4<TListenable0, T2, T4, TListenable5, TListenable0, T2, T4, TListenable5>(context, effect, $1, $2, $3, $4, key: key, immediate: immediate, once: once);
  }
