...
extension ContextWatchCallbackRecordRefExt37<TListenable1 extends Listenable, TListenable2 extends Listenable, TListenable3 extends Listenable, TListenable4 extends Listenable> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<TListenable2>, context_ref.ReadOnlyRef<TListenable3>, context_ref.ReadOnlyRef<TListenable4>) {
  /// {@macro mass_watch_only_explanation}
  R watchOnly<R>(
    BuildContext context,
    R Function(TListenable1, TListenable2, TListenable3, TListenable4) selector,
  ) {
    final contextWatch = InheritedContextWatch.of(context);
    
    final observable1 = contextWatch.getOrCreateObservable(context, $1);
    if (observable1 == null) return selector($1.of(context), $2.of(context), $3.of(context), $4.of(context));
  ...
  void watchEffect(
    BuildContext context,
    void Function(TListenable1, TListenable2, TListenable3, TListenable4) effect, {
    Object? key,
