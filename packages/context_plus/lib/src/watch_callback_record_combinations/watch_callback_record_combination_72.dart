...
extension ContextWatchCallbackRecordRefExt72<T1, TListenable2 extends Listenable, T3, T4> on (context_ref.ReadOnlyRef<Future<T1>>, context_ref.ReadOnlyRef<TListenable2>, context_ref.ReadOnlyRef<Stream<T3>>, context_ref.ReadOnlyRef<Stream<T4>>) {
