...
extension ContextWatchCallbackRecordRefExt67<T0, TListenable1 extends Listenable, T2> on (context_ref.ReadOnlyRef<Stream<T0>>, context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Stream<T2>>) {
  ...
  R watchOnly<R>(
    ...
    return watchOnly3<R, AsyncSnapshot<T0>, TListenable1, AsyncSnapshot<T2>, T0, TListenable1, T2>(context, selector, $1.of(context), $2.of(context), $3.of(context), ContextWatcherObservableType.stream, ContextWatcherObservableType.listenable, ContextWatcherObservableType.stream);
  }
