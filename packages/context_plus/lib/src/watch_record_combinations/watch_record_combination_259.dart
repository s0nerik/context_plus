...
extension ContextWatchRecordRefExt259<T0, T1, T3> on (context_ref.ReadOnlyRef<Future<T0>>, context_ref.ReadOnlyRef<Stream<T1>>, context_ref.ReadOnlyRef<Listenable>, context_ref.ReadOnlyRef<Future<T3>>) {
