...
extension ContextWatchCallbackRecordRefExt63<TListenable1 extends Listenable, T2, T3, T4> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Stream<T2>>, context_ref.ReadOnlyRef<Stream<T3>>, context_ref.ReadOnlyRef<Stream<T4>>) {
