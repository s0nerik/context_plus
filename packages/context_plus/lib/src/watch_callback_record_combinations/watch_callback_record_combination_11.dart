...
extension ContextWatchCallbackRecordRefExt11<TListenable1 extends Listenable, TListenable2 extends Listenable, T3> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<TListenable2>, context_ref.ReadOnlyRef<Future<T3>>) {
  /// {@macro mass_watch_only_explanation}
  R watchOnly<R>(
    BuildContext context,
    R Function(TListenable1, TListenable2, AsyncSnapshot<T3>) selector,
  ) {
    final contextWatch = InheritedContextWatch.of(context);
    
    final observable1 = contextWatch.getOrCreateObservable(context, $1);
    if (observable1 == null) return selector($1.of(context), $2.of(context), AsyncSnapshot<T3>.nothing());
  ...
  void watchEffect(
    BuildContext context,
    void Function(TListenable1, TListenable2, AsyncSnapshot<T3>) effect, {
    Object? key,
