...
extension ContextWatchCallbackRecordRefExt62<TListenable1 extends Listenable, T2, T3, T4> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Stream<T2>>, context_ref.ReadOnlyRef<Stream<T3>>, context_ref.ReadOnlyRef<Future<T4>>) {
  /// {@macro mass_watch_only_explanation}
  R watchOnly<R>(
    BuildContext context,
    R Function(TListenable1, AsyncSnapshot<T2>, AsyncSnapshot<T3>, AsyncSnapshot<T4>) selector,
  ) {
    final contextWatch = InheritedContextWatch.of(context);
    
    final observable1 = contextWatch.getOrCreateObservable(context, $1);
    if (observable1 == null) return selector($1.of(context), AsyncSnapshot<T2>.nothing(), AsyncSnapshot<T3>.nothing(), AsyncSnapshot<T4>.nothing());
  ...
  void watchEffect(
    BuildContext context,
    void Function(TListenable1, AsyncSnapshot<T2>, AsyncSnapshot<T3>, AsyncSnapshot<T4>) effect, {
    Object? key,
