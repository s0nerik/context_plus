...
extension ContextWatchCallbackRecordRefExt19<T1, TListenable2 extends Listenable, TListenable3 extends Listenable> on (context_ref.ReadOnlyRef<Future<T1>>, context_ref.ReadOnlyRef<TListenable2>, context_ref.ReadOnlyRef<TListenable3>) {
