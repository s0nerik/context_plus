...
extension ContextWatchCallbackRecordRefExt78<T1, T2, T3, T4> on (context_ref.ReadOnlyRef<Future<T1>>, context_ref.ReadOnlyRef<Future<T2>>, context_ref.ReadOnlyRef<Future<T3>>, context_ref.ReadOnlyRef<Stream<T4>>) {
