...
extension ContextWatchRecordRefExt121<T1, T2> on (context_ref.ReadOnlyRef<Listenable>, context_ref.ReadOnlyRef<Future<T1>>, context_ref.ReadOnlyRef<Future<T2>>, context_ref.ReadOnlyRef<Listenable>) {
