...
extension ContextWatchCallbackRecordRefExt165<TListenable0 extends ValueListenable<T1>, T1, TListenable2 extends ValueListenable<T3>, T3, TListenable4 extends ValueListenable<T5>, T5, TListenable6 extends ValueListenable<T7>, T7> on (context_ref.ReadOnlyRef<TListenable0>, context_ref.ReadOnlyRef<TListenable2>, context_ref.ReadOnlyRef<TListenable4>, context_ref.ReadOnlyRef<TListenable6>) {
  ...
  R watchOnly<R>(
    ...
    return watchOnly4<R, T1, T3, T5, T7, T1, T3, T5, T7>(context, selector, $1.of(context), $2.of(context), $3.of(context), $4.of(context), $1.of(context).value, $2.of(context).value, $3.of(context).value, $4.of(context).value);
  }
  ...
  void watchEffect(
    ...
    return watchEffect4<T1, T3, T5, T7, T1, T3, T5, T7>(context, effect, $1.of(context), $2.of(context), $3.of(context), $4.of(context), key: key, immediate: immediate, once: once);
  }
