...
extension ContextWatchCallbackRecordRefExt101<
...
>
  ...
  R watchOnly<R>(
    ...
    return watchOnly4<R, TListenable0, T2, T4, T6, TListenable0, T2, T4, T6>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect4<TListenable0, T2, T4, T6, TListenable0, T2, T4, T6>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
