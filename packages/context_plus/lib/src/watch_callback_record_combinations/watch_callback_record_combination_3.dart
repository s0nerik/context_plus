...
extension ContextWatchCallbackRecordRefExt3<TListenable1 extends Listenable, T2> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Stream<T2>>) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1.of(context), AsyncSnapshot<T2>.nothing());
  ...
  void watchEffect(
    BuildContext context,
    void Function(TListenable1, AsyncSnapshot<T2>) effect, {
    Object? key,
