...
extension ContextWatchCallbackRecordExt52<TListenable1 extends Listenable, T2, T3, TListenable4 extends Listenable> on (TListenable1, Future<T2>, Stream<T3>, TListenable4) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1, AsyncSnapshot<T2>.nothing(), AsyncSnapshot<T3>.nothing(), $4);
