...
extension ContextWatchCallbackRecordExt91<T1, TListenable2 extends Listenable, TListenable3 extends Listenable, TListenable4 extends Listenable> on (Stream<T1>, TListenable2, TListenable3, TListenable4) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), $2, $3, $4);
