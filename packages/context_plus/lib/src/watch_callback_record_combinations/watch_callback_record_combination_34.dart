...
extension ContextWatchCallbackRecordRefExt34<T1, T2, TListenable3 extends Listenable> on (context_ref.ReadOnlyRef<Stream<T1>>, context_ref.ReadOnlyRef<Stream<T2>>, context_ref.ReadOnlyRef<TListenable3>) {
