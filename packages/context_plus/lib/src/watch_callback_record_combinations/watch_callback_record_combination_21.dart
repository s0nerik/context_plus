...
extension ContextWatchCallbackRecordRefExt21<T1, TListenable2 extends Listenable, T3> on (context_ref.ReadOnlyRef<Future<T1>>, context_ref.ReadOnlyRef<TListenable2>, context_ref.ReadOnlyRef<Stream<T3>>) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), $2.of(context), AsyncSnapshot<T3>.nothing());
