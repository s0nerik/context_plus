...
extension ContextWatchCallbackRecordExt10<TListenable1 extends Listenable, TListenable2 extends Listenable, TListenable3 extends Listenable> on (TListenable1, TListenable2, TListenable3) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1, $2, $3);
