...
extension ContextWatchCallbackRecordRefExt5<
...
>
  ...
  R watchOnly<R>(BuildContext context, R Function(T1, T3) selector) {
    return watchOnly2<R, T1, T3, T1, T3>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect2<T1, T3, T1, T3>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
