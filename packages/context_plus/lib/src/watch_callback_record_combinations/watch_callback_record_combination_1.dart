...
extension ContextWatchCallbackRecordRefExt1<
...
>
  ...
  R watchOnly<R>(BuildContext context, R Function(TListenable0, T2) selector) {
    return watchOnly2<R, TListenable0, T2, TListenable0, T2>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect2<TListenable0, T2, TListenable0, T2>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
