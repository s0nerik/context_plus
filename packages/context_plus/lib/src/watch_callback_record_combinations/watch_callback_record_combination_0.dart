...
extension ContextWatchCallbackRecordRefExt0<TListenable0 extends Listenable, TListenable1 extends Listenable> on (context_ref.ReadOnlyRef<TListenable0>, context_ref.ReadOnlyRef<TListenable1>) {
  ...
  R watchOnly<R>(
    ...
    return watchOnly2<R, TListenable0, TListenable1, TListenable0, TListenable1>(context, selector, $1.of(context), $2.of(context), $1.of(context), $2.of(context));
  }
  ...
  void watchEffect(
    ...
    return watchEffect2<TListenable0, TListenable1, TListenable0, TListenable1>(context, effect, $1.of(context), $2.of(context), key: key, immediate: immediate, once: once);
  }
