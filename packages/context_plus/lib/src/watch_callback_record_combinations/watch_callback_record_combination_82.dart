...
extension ContextWatchCallbackRecordRefExt82<
...
>
  ...
  R watchOnly<R>(
    ...
    R Function(TListenable0, TListenable1, TListenable2, AsyncSnapshot<T3>)
    selector,
  ) {
    return watchOnly4<
      R,
  ...
  void watchEffect(
    BuildContext context,
    void Function(TListenable0, TListenable1, TListenable2, AsyncSnapshot<T3>)
    effect, {
    Object? key,
