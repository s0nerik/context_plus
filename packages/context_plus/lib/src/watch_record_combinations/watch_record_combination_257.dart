...
extension ContextWatchRecordRefExt257<T0, T1> on (context_ref.ReadOnlyRef<Future<T0>>, context_ref.ReadOnlyRef<Stream<T1>>, context_ref.ReadOnlyRef<Listenable>, context_ref.ReadOnlyRef<Listenable>) {
