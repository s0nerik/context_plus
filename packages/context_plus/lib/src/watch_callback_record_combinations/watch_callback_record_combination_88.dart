...
extension ContextWatchCallbackRecordRefExt88<T1, T2, T3, TListenable4 extends Listenable> on (context_ref.ReadOnlyRef<Future<T1>>, context_ref.ReadOnlyRef<Stream<T2>>, context_ref.ReadOnlyRef<Stream<T3>>, context_ref.ReadOnlyRef<TListenable4>) {
