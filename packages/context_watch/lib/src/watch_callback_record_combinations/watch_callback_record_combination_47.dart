...
extension ContextWatchCallbackRecordExt47<TListenable1 extends Listenable, T2, TListenable3 extends Listenable, T4> on (TListenable1, Future<T2>, TListenable3, Future<T4>) {
