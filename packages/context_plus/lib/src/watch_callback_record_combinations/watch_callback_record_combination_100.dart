...
extension ContextWatchCallbackRecordRefExt100<T1, T2, TListenable3 extends Listenable, TListenable4 extends Listenable> on (context_ref.ReadOnlyRef<Stream<T1>>, context_ref.ReadOnlyRef<Future<T2>>, context_ref.ReadOnlyRef<TListenable3>, context_ref.ReadOnlyRef<TListenable4>) {
