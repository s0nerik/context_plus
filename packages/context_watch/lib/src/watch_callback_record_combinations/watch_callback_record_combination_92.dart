...
extension ContextWatchCallbackRecordExt92<T1, TListenable2 extends Listenable, TListenable3 extends Listenable, T4> on (Stream<T1>, TListenable2, TListenable3, Future<T4>) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), $2, $3, AsyncSnapshot<T4>.nothing());
