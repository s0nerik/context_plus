...
extension ContextWatchCallbackRecordExt55<TListenable1 extends Listenable, T2, TListenable3 extends Listenable, TListenable4 extends Listenable> on (TListenable1, Stream<T2>, TListenable3, TListenable4) {
