...
extension ContextWatchCallbackRecordRefExt16<TListenable1 extends Listenable, T2, TListenable3 extends Listenable> on (context_ref.ReadOnlyRef<TListenable1>, context_ref.ReadOnlyRef<Stream<T2>>, context_ref.ReadOnlyRef<TListenable3>) {
  /// {@macro mass_watch_only_explanation}
  R watchOnly<R>(
    BuildContext context,
    R Function(TListenable1, AsyncSnapshot<T2>, TListenable3) selector,
  ) {
    final contextWatch = InheritedContextWatch.of(context);
    
    final observable1 = contextWatch.getOrCreateObservable(context, $1);
    if (observable1 == null) return selector($1.of(context), AsyncSnapshot<T2>.nothing(), $3.of(context));
  ...
  void watchEffect(
    BuildContext context,
    void Function(TListenable1, AsyncSnapshot<T2>, TListenable3) effect, {
    Object? key,
