...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1289: (x0,x1,x2,x3,x4,x5) => x0.call(x1,x2,x3,x4,x5),
      _1290: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      _1291: (x0,x1,x2,x3,x4) => x0.call(x1,x2,x3,x4),
      _1292: x0 => x0.call(),
      ...
      _1297: (x0,x1,x2,x3,x4,x5,x6) => x0.call(x1,x2,x3,x4,x5,x6),
      _1298: x0 => x0.decode(),
      _1299: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1300: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1303: x0 => x0.send(),
      _1304: () => new XMLHttpRequest(),
      _1305: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      _1306: (x0,x1,x2,x3,x4) => x0.call(x1,x2,x3,x4),
      _1309: x0 => x0.call(),
      _1310: Date.now,
      ...
      _1326: x0 => new FinalizationRegistry(x0),
      _1327: (x0,x1,x2,x3) => x0.register(x1,x2,x3),
      _1328: (x0,x1,x2) => x0.register(x1,x2),
      _1329: (x0,x1) => x0.unregister(x1),
      _1331: () => globalThis.WeakRef,
      _1332: () => globalThis.FinalizationRegistry,
      _1334: s => JSON.stringify(s),
      _1335: s => printToConsole(s),
      _1336: (o, p, r) => o.replaceAll(p, () => r),
      _1337: (o, p, r) => o.replace(p, () => r),
      _1338: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1339: s => s.toUpperCase(),
      _1340: s => s.trim(),
      _1341: s => s.trimLeft(),
      _1342: s => s.trimRight(),
      _1343: (string, times) => string.repeat(times),
      _1344: Function.prototype.call.bind(String.prototype.indexOf),
      _1345: (s, p, i) => s.lastIndexOf(p, i),
      _1346: (string, token) => string.split(token),
      _1347: Object.is,
      _1348: o => o instanceof Array,
      _1349: (a, i) => a.push(i),
      _1353: a => a.pop(),
      _1354: (a, i) => a.splice(i, 1),
      _1355: (a, s) => a.join(s),
      _1356: (a, s, e) => a.slice(s, e),
      _1358: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1359: a => a.length,
      _1360: (a, l) => a.length = l,
      _1361: (a, i) => a[i],
      _1362: (a, i, v) => a[i] = v,
      _1364: o => {
      ...
      _1365: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1367: o => o instanceof Uint8Array,
      _1368: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1369: o => o instanceof Int8Array,
      _1370: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1371: o => o instanceof Uint8ClampedArray,
      _1372: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1373: o => o instanceof Uint16Array,
      _1374: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1375: o => o instanceof Int16Array,
      _1376: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1377: o => o instanceof Uint32Array,
      _1378: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1379: o => o instanceof Int32Array,
      _1380: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1382: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1383: o => o instanceof Float32Array,
      _1384: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1385: o => o instanceof Float64Array,
      _1386: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1387: (t, s) => t.set(s),
      _1389: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1391: o => o.buffer,
      _1392: o => o.byteOffset,
      _1393: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1394: (b, o) => new DataView(b, o),
      _1395: (b, o, l) => new DataView(b, o, l),
      _1396: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1397: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1398: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1399: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1400: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1401: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1402: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1403: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1404: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1405: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1406: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1407: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1410: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1411: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1412: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1413: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1414: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1415: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1428: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1429: (handle) => clearTimeout(handle),
      _1430: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1431: (handle) => clearInterval(handle),
      _1432: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1433: () => Date.now(),
      _1438: o => Object.keys(o),
      ...
      _1444: x0 => x0.abort(),
      _1445: () => new AbortController(),
      _1446: x0 => x0.getReader(),
      _1447: x0 => x0.read(),
      _1448: x0 => x0.cancel(),
      _1451: (x0,x1) => x0.createElement(x1),
      ...
      _1456: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1457: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1474: (s, m) => {
        try {
      ...
      _2911: (x0,x1) => { x0.type = x1 },
      _2917: (x0,x1) => { x0.defer = x1 },
      _3378: () => globalThis.window,
      _3441: x0 => x0.navigator,
      _3830: x0 => x0.userAgent,
      _5983: x0 => x0.signal,
      _6057: () => globalThis.document,
      _6139: x0 => x0.body,
      _7822: x0 => x0.value,
      _7824: x0 => x0.done,
      _8526: x0 => x0.url,
      _8528: x0 => x0.status,
      _8530: x0 => x0.statusText,
      _8531: x0 => x0.headers,
      _8532: x0 => x0.body,
      _12905: () => globalThis.document,
      _12906: () => globalThis.window,
      _12911: (x0,x1) => { x0.height = x1 },
      _12913: (x0,x1) => { x0.width = x1 },
      _12916: x0 => x0.head,
      _12917: x0 => x0.classList,
      _12921: (x0,x1) => { x0.innerText = x1 },
      _12922: x0 => x0.style,
      _12924: x0 => x0.sheet,
      _12925: x0 => x0.src,
      _12926: (x0,x1) => { x0.src = x1 },
      _12927: x0 => x0.naturalWidth,
      _12928: x0 => x0.naturalHeight,
      _12935: x0 => x0.offsetX,
      _12936: x0 => x0.offsetY,
      _12937: x0 => x0.button,
      _12944: x0 => x0.status,
      _12945: (x0,x1) => { x0.responseType = x1 },
      _12947: x0 => x0.response,
