...
extension ContextWatchCallbackRecordRefExt71<
  T0,
...
>
  ...
  R watchOnly<R>(
    ...
    return watchOnly3<R, AsyncSnapshot<T0>, T2, AsyncSnapshot<T3>, T0, T2, T3>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect3<AsyncSnapshot<T0>, T2, AsyncSnapshot<T3>, T0, T2, T3>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
