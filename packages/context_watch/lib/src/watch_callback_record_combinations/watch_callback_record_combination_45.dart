...
extension ContextWatchCallbackRecordExt45<TListenable1 extends Listenable, TListenable2 extends Listenable, T3, T4> on (TListenable1, TListenable2, Stream<T3>, Stream<T4>) {
