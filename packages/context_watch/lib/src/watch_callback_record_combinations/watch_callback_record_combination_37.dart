...
extension ContextWatchCallbackRecordExt37<TListenable1 extends Listenable, TListenable2 extends Listenable, TListenable3 extends Listenable, TListenable4 extends Listenable> on (TListenable1, TListenable2, TListenable3, TListenable4) {
  ...
  R watchOnly<R>(
    ...
    if (observable1 == null) return selector($1, $2, $3, $4);
  ...
  void watchEffect(
    ...
    final obs4 = contextWatch.getOrCreateObservable(context, $4)!;
