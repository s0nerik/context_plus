...
extension ContextWatchCallbackRecordRefExt101<T1, T2, TListenable3 extends Listenable, T4> on (context_ref.ReadOnlyRef<Stream<T1>>, context_ref.ReadOnlyRef<Future<T2>>, context_ref.ReadOnlyRef<TListenable3>, context_ref.ReadOnlyRef<Future<T4>>) {
  /// {@macro mass_watch_only_explanation}
  R watchOnly<R>(
    BuildContext context,
    R Function(AsyncSnapshot<T1>, AsyncSnapshot<T2>, TListenable3, AsyncSnapshot<T4>) selector,
  ) {
    final contextWatch = InheritedContextWatch.of(context);
    
    final observable1 = contextWatch.getOrCreateObservable<T1>(context, $1);
    if (observable1 == null) return selector(AsyncSnapshot<T1>.nothing(), AsyncSnapshot<T2>.nothing(), $3.of(context), AsyncSnapshot<T4>.nothing());
  ...
  void watchEffect(
    BuildContext context,
    void Function(AsyncSnapshot<T1>, AsyncSnapshot<T2>, TListenable3, AsyncSnapshot<T4>) effect, {
    Object? key,
