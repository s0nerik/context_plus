...
extension ContextWatchCallbackRecordRefExt36<
...
>
  ...
  R watchOnly<R>(
    ...
    return watchOnly3<R, T1, T3, TListenable4, T1, T3, TListenable4>(
      context,
      selector,
      $1.of(context),
      $2.of(context),
  ...
  void watchEffect(
    ...
    return watchEffect3<T1, T3, TListenable4, T1, T3, TListenable4>(
      context,
      effect,
      $1.of(context),
      $2.of(context),
