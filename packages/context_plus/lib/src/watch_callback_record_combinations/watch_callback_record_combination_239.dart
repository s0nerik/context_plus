...
extension ContextWatchCallbackRecordRefExt239<
  T0,
...
>
  ...
  R watchOnly<R>(
    ...
    R Function(AsyncSnapshot<T0>, T2, AsyncSnapshot<T3>, AsyncSnapshot<T4>)
    selector,
  ) {
    return watchOnly4<
      R,
  ...
  void watchEffect(
    BuildContext context,
    void Function(AsyncSnapshot<T0>, T2, AsyncSnapshot<T3>, AsyncSnapshot<T4>)
    effect, {
    Object? key,
