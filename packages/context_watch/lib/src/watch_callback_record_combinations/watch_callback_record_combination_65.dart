...
extension ContextWatchCallbackRecordExt65<T1, TListenable2 extends Listenable, TListenable3 extends Listenable, T4> on (Future<T1>, TListenable2, TListenable3, Future<T4>) {
